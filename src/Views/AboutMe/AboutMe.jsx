        ...
        <div className='AboutMe'>
            ...
            <div className="process-wrapper">
                <div id="progress-bar-container">
                    <ul>
                        <li className={`step step01 ${activeYear === 'ano2022' ? 'active' : ''}`} onClick={() => handleStepClick('3%', 'ano2022')}>
                            <div className="step-inner">2022</div>
                        </li>
                        <li className={`step step02 ${activeYear === 'ano2023' ? 'active' : ''}`} onClick={() => handleStepClick('25%', 'ano2023')}>
                            <div className="step-inner">2023</div>
                        </li>
                        <li className={`step step03 ${activeYear === 'ano2024' ? 'active' : ''}`} onClick={() => handleStepClick('50%', 'ano2024')}>
